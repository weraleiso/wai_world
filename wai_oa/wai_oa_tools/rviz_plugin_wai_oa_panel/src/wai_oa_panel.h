...
namespace rviz_plugin_wai_oa_panel
{
    ...
    protected:
        ...
        QWidget* m_wid_ethics_log;
        QLabel* m_lbl_ethics_log;
        QLabel* m_lbl_ethics_indicator_log;
        QLabel* m_lbl_ethics_properties_log;
        QTreeWidget* m_qtw_ethics;
        QLabel* m_lbl_ethics_decisions_log;
        QProgressBar* m_stb_ethics_log;
        //QTextBrowser* m_txb_ethics_properties_log;
        QTextBrowser* m_txb_ethics_decisions_log;
        QPushButton* m_cmd_reset_ethics_log;
        ...
        ros::Subscriber m_sub_s_ethics_log;
        ros::Subscriber m_sub_s_ethics_properties;

        // Callbacks
        void cb_sub_s_session_log(const std_msgs::HeaderPtr&);
        void cb_sub_s_rep_sequence_log(const std_msgs::StringPtr&);
        void cb_sub_s_ethics_log(const std_msgs::StringPtr&);
        void cb_sub_f32_ethics_properties(std_msgs::Float32MultiArray);
    };

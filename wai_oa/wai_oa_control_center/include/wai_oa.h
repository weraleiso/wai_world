...
/////////////////////////////////////////////////
class WAIOpenAuditorium:WAIWorkspace
{
    ...
    float F_PRESENTER_MOOD; // Ethical properties
    float F_PRESENTER_PRESENCE_VISUAL;

    // Declare Flags For Interactions
    ...
    bool B_EVENT_STARTUP_FINISHED; // EVENTS that are NON-input device specific

    // Declare ROS Handles
    ros::NodeHandle nh;
    image_transport::ImageTransport it;

    // Declare Timers and Times
    ...
    */
    ...
    ros::Publisher pub_emp_robot_idle;
    ros::Publisher pub_emp_robot_startup;
    ros::Publisher pub_emp_robot_takeoff;
    ros::Publisher pub_emp_robot_land;
    ros::Publisher pub_emp_robot_shutdown;
    ...
    WAISymbol* wai_oa_rep_trigger_scene_prev;
    WAISymbol* wai_oa_rep_trigger_scene_next;
    WAISymbol* wai_oa_rep_trigger_basic;
    WAISymbol* wai_oa_rep_trigger_audience;
    WAISymbol* wai_oa_rep_graph_3d_function;
    WAISymbol* wai_oa_rep_graph_3d_eval;
    WAISymbol* wai_oa_rep_graph_3d_stats;
    WAISymbol* wai_oa_rep_wim;
    WAISymbol* wai_oa_rep_scaffolding;
    WAISymbol* wai_oa_rep_scaffolding_2;
    ...
    // ETHICAL CONTEXT
    WAIEthicalModel wai_oa_ethical_model;
    ros::Subscriber sub_fma_ethi_prop_from_audience;
    ros::Publisher pub_fma_ethi_prop_summary;
    void cb_sub_fma_ethi_prop_from_audience(const std_msgs::Float32MultiArray::ConstPtr& msg);
...
public:
    ...
    void SetupWorkspacePresenterFromScript();
    ...
    void SetupSessionLoadModel(); void SetupSessionLoadView();
    ...
    void SetupPresenceVisualModel(); void SetupPresenceVisualView();
    ...
    void SetupLearningModeScaffoldingModel(); void SetupLearningModeScaffoldingView();
    void SetupEvalModel(); void SetupEvalView();
    void SetupVoiceCommandIntelModel(); void SetupVoiceCommandIntelView();
    void SetupVoiceCommandMarvinModel(); void SetupVoiceCommandMarvinView();
    ...
    void SetupWIMAudienceShareMaterialModel(); void SetupWIMAudienceShareMaterialView(); //void SetupWIMAudienceShareMaterialLeaveState();
    ...
    void SetupMoodModel(); void SetupMoodView(); void SetupMoodLeaveState();
    ...
    std::string GetStateNameCurrentForIntel();

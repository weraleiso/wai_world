...
/////////////////////////////////////////////////
class WAIAuditoriumTriggerSessionLoad:public WAIAuditoriumTrigger
{
    WAIOpenAuditorium* m_wai_auditorium;

public:
    WAIAuditoriumTriggerSessionLoad(WAIOpenAuditorium* wai_auditorium);
    ~WAIAuditoriumTriggerSessionLoad();
...
class WAIAuditoriumTriggerLearningModeCooperative:public WAIAuditoriumTrigger
{
    WAIOpenAuditorium* m_wai_auditorium;

public:
    WAIAuditoriumTriggerLearningModeCooperative(WAIOpenAuditorium* wai_auditorium);
    ~WAIAuditoriumTriggerLearningModeCooperative();

    void Activate();
};

class WAIAuditoriumTriggerLearningModeScaffolding:public WAIAuditoriumTrigger
{
    WAIOpenAuditorium* m_wai_auditorium;

public:
    WAIAuditoriumTriggerLearningModeScaffolding(WAIOpenAuditorium* wai_auditorium);
    ~WAIAuditoriumTriggerLearningModeScaffolding();
...
class WAIAuditoriumTriggerVoiceCommandMarvin:public WAIAuditoriumTrigger
{
    WAIOpenAuditorium* m_wai_auditorium;

public:
    WAIAuditoriumTriggerVoiceCommandMarvin(WAIOpenAuditorium* wai_auditorium);
    ~WAIAuditoriumTriggerVoiceCommandMarvin();
...
class WAIAuditoriumTriggerAudienceShareMaterial:public WAIAuditoriumTrigger
{
    WAIOpenAuditorium* m_wai_auditorium;

public:
    WAIAuditoriumTriggerAudienceShareMaterial(WAIOpenAuditorium* wai_auditorium);
    ~WAIAuditoriumTriggerAudienceShareMaterial();
...
class WAIAuditoriumTriggerMood:public WAIAuditoriumTrigger
{
    WAIOpenAuditorium* m_wai_auditorium;

public:
    WAIAuditoriumTriggerMood(WAIOpenAuditorium* wai_auditorium);
    ~WAIAuditoriumTriggerMood();
...
class WAIOATriggers
{
    ...
    ros::Subscriber sub_bol_trg_mob_presence_visual;
    ...
    ros::Subscriber sub_bol_trg_mob_voice_command_marvin;
    ...
    bool b_trg_mob_presence_visual;
    ...
    bool b_trg_mob_voice_command_marvin;
...
public:
    // VOICE (INTENT) - Helper members (Make publicly accessible to INTEL)
    bool b_trg_voi_scene_prev;
    bool b_trg_voi_scene_next;
    bool b_trg_voi_camera_rviz_default;
    bool b_trg_voi_camera_rviz_cycle;
    bool b_trg_voi_camera_rviz_enforce;
    bool b_trg_voi_camera_rviz_idle;
    bool b_trg_voi_camera_rviz_follow;
    bool b_trg_voi_introduction;
    bool b_trg_voi_presence_visual;
    bool b_trg_voi_body_interaction;
    bool b_trg_voi_avatar;
    bool b_trg_voi_lectern;
    bool b_trg_voi_table;
    bool b_trg_voi_audio;
    bool b_trg_voi_audience_eval_graph;
    bool b_trg_voi_audience_eval_metaphorebowl;
    bool b_trg_voi_audience_eval_metaphorebalance;
    bool b_trg_voi_audience_eval_metaphoremarvin;
    bool b_trg_voi_audience_request_reject;
    bool b_trg_voi_audience_request_accept;
    bool b_trg_voi_audience_focus_down;
    bool b_trg_voi_audience_focus_up;
    bool b_trg_voi_audience_focus_left;
    bool b_trg_voi_audience_focus_right;
    bool b_trg_voi_wim_audience_select;
    bool b_trg_voi_audience_eval_part_minus;
    bool b_trg_voi_audience_eval_part_tilde;
    bool b_trg_voi_audience_eval_part_plus;
    bool b_trg_voi_audience_eval_exam_insufficient;
    bool b_trg_voi_audience_eval_exam_sufficient;
    bool b_trg_voi_audience_eval_exam_satisfactory;
    bool b_trg_voi_audience_eval_exam_good;
    bool b_trg_voi_audience_eval_exam_very_good;
    bool b_trg_voi_rep_detail_focus;
    bool b_trg_voi_rep_detail_select;
    bool b_trg_voi_rep_detail_rot;
    bool b_trg_voi_learning_mode_plen;
    bool b_trg_voi_learning_mode_coop;

private:
    // TRIGGERs
    WAIAuditoriumTrigger* m_trg_session_load;
    ...
    WAIAuditoriumTrigger* m_trg_mood;
    WAIAuditoriumTrigger* m_trg_presence_visual;
    ...
    WAIAuditoriumTrigger* m_trg_voice_command_marvin;
    ...
    WAIAuditoriumTrigger* m_trg_audience_share_material;
    ...
    WAIAuditoriumTrigger* m_trg_learning_mode_scaff;
    ...
    void cb_sub_bol_trg_mob_presence_visual(const std_msgs::BoolPtr&);
    ...
    void cb_sub_bol_trg_mob_voice_command_marvin(const std_msgs::BoolPtr&);

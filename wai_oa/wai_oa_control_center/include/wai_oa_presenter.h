...
/////////////////////////////////////////////////
class WAIOAPresenter:WAINatural
{
    ...
    ros::Subscriber sub_img_camera_2d;
    ...
    ros::Publisher pub_img_camera_2d;
    ...
    WAISymbol* wai_oa_rep_ooi_hand_right;
    WAISymbol* wai_oa_rep_ooi_hand_left;
    WAISymbol* wai_oa_rep_ooi_head;

    ros::Timer m_tmr_presenter;
    ros::Timer m_tmr_presenter_tf;
    ...
    std::vector<int> par_img_avatar_2d={cv::IMWRITE_JPEG_QUALITY,75};
    std::vector<uchar> uch_buf_avatar_2d;
    sensor_msgs::CompressedImage msg_img_avatar_2d;

    void cb_tmr_presenter(const ros::TimerEvent& event);
    void cb_tmr_presenter_tf(const ros::TimerEvent& event);
...
public:
    ...
    void UpdateModel(float f_mood=0.4,float f_presence_visual=0.25,bool b_enable_kmf=false);
    void UpdateView();
    float GetMood();
    void SetMood(float f_mood=0.4);
    float GetPresenceVisual();
    void SetPresenceVisual(float f_presence_visual);
    ...
    tf::Transform GetPresenterPose();
    geometry_msgs::PoseStamped GetPresenterPoseStamped();

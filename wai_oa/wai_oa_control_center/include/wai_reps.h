...
/////////////////////////////////////////////////
/// Base classes of Representatives
/////////////////////////////////////////////////

class WAIRepresentative
{
    std::string m_s_name;
public:
    WAIRepresentative(){
...
class WAIWorkspace:WAIRepresentative
{
public:
};

class WAIRock:WAIRepresentative
{
    std::string m_s_material;
public:
    void SetMaterial(std::string s_material)
    {
        m_s_material=s_material;
    }
};

class WAINatural:WAIRepresentative
{
    float m_f_body_height;
public:
    void SetBodyHeight(float f_body_height)
    {
        m_f_body_height=f_body_height;
    }
};

class WAIArtificial:WAIRepresentative
{
    int m_i_intel_level;
public:
    void SetIntelligenceLevel(int i_intel_level)
    {
        m_i_intel_level=i_intel_level;
    }
};

class WAISymbol:WAIRepresentative
{
protected:
    static int i_rep_id;
...
public:
    static WAISymbol *create_representative(std::string config);
...
/////////////////////////////////////////////////
class WAIRepTrigger:public WAISymbol
{
...
class WAIRepOOI:public WAISymbol
{
...
class WAIRepWIM:public WAISymbol
{
...
class WAIRepGraph3D:public WAISymbol
{
...
class WAIRepGraphStats:public WAISymbol
{
    tf::Vector3 m_vc3_position;
    tf::Quaternion m_qua_orientation;
    tf::Vector3 m_vc3_outer_bounds;

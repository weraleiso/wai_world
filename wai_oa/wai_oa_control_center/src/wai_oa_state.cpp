...
void WAIOpenAuditorium::StateTransitionTo(WAIOAState* state,bool b_invoke_all_requests)
{
    ...
    std::string s_mood="";
    if(wai_oa_presenter.GetMood()>=0.8f) s_mood=":))";
    else if(wai_oa_presenter.GetMood()>=0.6f) s_mood=":)";
    else if(wai_oa_presenter.GetMood()>=0.4f) s_mood=":|";
    else if(wai_oa_presenter.GetMood()>=0.2f) s_mood=":(";
    else if(wai_oa_presenter.GetMood()>=0.0f) s_mood=":((";
    else s_mood=":O";
    wai_oa_session_manager.SetOAStatusLabel(
                "MOOD: <b>"+s_mood+
                "</b>, STA: "+GetStateNameCurrent()+
                ", LST TRG: "+GetEventNameInpDevLast()+
                ", CAM FRM: "+GetCameraFrameNames()+
                ", AUD SEL: "+std::to_string(i_audience_id_selected)+
                ", REP SEL: ["+GetRepSelectedClean()+"|"+GetRepDetailSelectedClean()+"]" );
}
...
void WAIOpenAuditorium::RequestSetupModel()
{
    ...
    {
        // Play workspace-specific soundFX
        wai_oa_intel.InteractionVoiceFromFile(GetStateNameCurrent());

        // Intel confirms state transition
        wai_oa_intel.InteractionVoiceFromFile(GetStateNameCurrentForIntel());
    }
...
// STATE: StatePlenumPresenting
void StatePlenumSettingUpSessionLoad::HandleSetupModel()
{
    wai_oa_context->SetupSessionLoadModel();
}
void StatePlenumSettingUpSessionLoad::HandleSetupView()
{
    wai_oa_context->SetupSessionLoadView();
}
void StatePlenumSettingUpSessionLoad::HandleLeaveState()
{
...
void StatePlenumSettingUpScenePrev::HandleSetupView()
{
    ...
    wai_oa_context->SetupWorkspacePresenterFromScript();
}
...
// STATE: StatePlenumSettingUpPresenceVisual
void StatePlenumSettingUpPresenceVisual::HandleSetupModel()
{
    wai_oa_context->SetupPresenceVisualModel();
}
void StatePlenumSettingUpPresenceVisual::HandleSetupView()
{
    wai_oa_context->SetupPresenceVisualView();
}
void StatePlenumSettingUpPresenceVisual::HandleLeaveState()
{
    this->wai_oa_context->StateTransitionTo(new StatePlenumPresenting,true);
}
...
// STATE: StateLearningModeScaffoldingPrepare
void StateLearningModeScaffoldingPrepare::HandleSetupModel()
{
    wai_oa_context->SetupLearningModeScaffoldingModel();
}
void StateLearningModeScaffoldingPrepare::HandleSetupView()
{
    wai_oa_context->SetupLearningModeScaffoldingView();
}
void StateLearningModeScaffoldingPrepare::HandleLeaveState()
{
    this->wai_oa_context->StateTransitionTo(new StatePlenumPresenting,true);
}
...
// STATE: StatePlenumSettingUpVoiceCommandIntel
void StatePlenumSettingUpVoiceCommandIntel::HandleSetupModel()
{
    wai_oa_context->SetupVoiceCommandIntelModel();
}
void StatePlenumSettingUpVoiceCommandIntel::HandleSetupView()
{
    wai_oa_context->SetupVoiceCommandIntelView();
}
void StatePlenumSettingUpVoiceCommandIntel::HandleLeaveState()
{
    this->wai_oa_context->StateTransitionTo(new StatePlenumPresenting,true);
}


// STATE: StatePlenumSettingUpVoiceCommandMarvin
void StatePlenumSettingUpVoiceCommandMarvin::HandleSetupModel()
{
    wai_oa_context->SetupVoiceCommandMarvinModel();
}
void StatePlenumSettingUpVoiceCommandMarvin::HandleSetupView()
{
    wai_oa_context->SetupVoiceCommandMarvinView();
}
void StatePlenumSettingUpVoiceCommandMarvin::HandleLeaveState()
{
    this->wai_oa_context->StateTransitionTo(new StatePlenumPresenting,true);
}
...
// STATE: StatePlenumSettingUpAudienceShareMaterial
void StatePlenumSettingUpAudienceShareMaterial::HandleSetupModel()
{
    wai_oa_context->SetupWIMAudienceShareMaterialModel();
}
void StatePlenumSettingUpAudienceShareMaterial::HandleSetupView()
{
    wai_oa_context->SetupWIMAudienceShareMaterialView();
}
void StatePlenumSettingUpAudienceShareMaterial::HandleLeaveState()
{
    // Return to presenting
    this->wai_oa_context->StateTransitionTo(new StatePlenumPresenting,true);
}
...
// STATE: StatePlenumSettingUpMood
void StatePlenumSettingUpMood::HandleSetupModel()
{
    wai_oa_context->SetupMoodModel();
}
void StatePlenumSettingUpMood::HandleSetupView()
{
    wai_oa_context->SetupMoodView();
}
void StatePlenumSettingUpMood::HandleLeaveState()
{
    this->wai_oa_context->SetupIntroductionLeaveState();
    this->wai_oa_context->StateTransitionTo(new StatePlenumPresenting,true);
}

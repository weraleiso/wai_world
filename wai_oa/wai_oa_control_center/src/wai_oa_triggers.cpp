...
// 0.SESSION Interactions
WAIAuditoriumTriggerSessionLoad::WAIAuditoriumTriggerSessionLoad(WAIOpenAuditorium* wai_auditorium)
{
    m_wai_auditorium=wai_auditorium;
}
WAIAuditoriumTriggerSessionLoad::~WAIAuditoriumTriggerSessionLoad()
{

}
void WAIAuditoriumTriggerSessionLoad::Activate()
{
    if(m_wai_auditorium->GetStateNameCurrent().compare("PlenumPresenting")==0)
    {
        m_wai_auditorium->SetTimeTriggerActivated(ros::Time::now());
        m_wai_auditorium->StateTransitionTo(new StatePlenumSettingUpSessionLoad,true);
    }
}
...
WAIAuditoriumTriggerMood::WAIAuditoriumTriggerMood(WAIOpenAuditorium* wai_auditorium)
{
    m_wai_auditorium=wai_auditorium;
}
WAIAuditoriumTriggerMood::~WAIAuditoriumTriggerMood()
{

}
void WAIAuditoriumTriggerMood::Activate()
{
    if(m_wai_auditorium->GetStateNameCurrent().compare("PlenumPresenting")==0)
    {
        m_wai_auditorium->SetTimeTriggerActivated(ros::Time::now());
        m_wai_auditorium->StateTransitionTo(new StatePlenumSettingUpMood,true);
    }
}
...
void WAIAuditoriumTriggerPresenceMode::Activate()
{
    ...
    {
        m_wai_auditorium->SetTimeTriggerActivated(ros::Time::now());
        m_wai_auditorium->StateTransitionTo(new StatePlenumSettingUpPresenceVisual,true);
    }
}
...
void WAIAuditoriumTriggerVoiceCommand::Activate()
{
    ...
    {
        m_wai_auditorium->SetTimeTriggerActivated(ros::Time::now());
        m_wai_auditorium->StateTransitionTo(new StatePlenumSettingUpVoiceCommandIntel,true);
    }
}

WAIAuditoriumTriggerVoiceCommandMarvin::WAIAuditoriumTriggerVoiceCommandMarvin(WAIOpenAuditorium* wai_auditorium)
{
    m_wai_auditorium=wai_auditorium;
}
WAIAuditoriumTriggerVoiceCommandMarvin::~WAIAuditoriumTriggerVoiceCommandMarvin()
{

}
void WAIAuditoriumTriggerVoiceCommandMarvin::Activate()
{
    if(m_wai_auditorium->GetStateNameCurrent().compare("PlenumPresenting")==0)
    {
        m_wai_auditorium->SetTimeTriggerActivated(ros::Time::now());
        m_wai_auditorium->StateTransitionTo(new StatePlenumSettingUpVoiceCommandMarvin,true);
    }
}
...
WAIAuditoriumTriggerAudienceShareMaterial::WAIAuditoriumTriggerAudienceShareMaterial(WAIOpenAuditorium* wai_auditorium)
{
    m_wai_auditorium=wai_auditorium;
}
WAIAuditoriumTriggerAudienceShareMaterial::~WAIAuditoriumTriggerAudienceShareMaterial()
{

}
void WAIAuditoriumTriggerAudienceShareMaterial::Activate()
{
    if(m_wai_auditorium->GetStateNameCurrent().compare("PlenumPresenting")==0)
    {
        m_wai_auditorium->SetTimeTriggerActivated(ros::Time::now());
        m_wai_auditorium->StateTransitionTo(new StatePlenumSettingUpAudienceShareMaterial,true);
    }
}
...
WAIAuditoriumTriggerLearningModeCooperative::WAIAuditoriumTriggerLearningModeCooperative(WAIOpenAuditorium* wai_auditorium)
{
    m_wai_auditorium=wai_auditorium;
}
WAIAuditoriumTriggerLearningModeCooperative::~WAIAuditoriumTriggerLearningModeCooperative()
{

}
void WAIAuditoriumTriggerLearningModeCooperative::Activate()
{
    if(m_wai_auditorium->GetStateNameCurrent().compare("PlenumPresenting")==0)
    {
        m_wai_auditorium->SetTimeTriggerActivated(ros::Time::now());
...
WAIAuditoriumTriggerLearningModeScaffolding::WAIAuditoriumTriggerLearningModeScaffolding(WAIOpenAuditorium* wai_auditorium)
{
    m_wai_auditorium=wai_auditorium;
}
WAIAuditoriumTriggerLearningModeScaffolding::~WAIAuditoriumTriggerLearningModeScaffolding()
{

}
void WAIAuditoriumTriggerLearningModeScaffolding::Activate()
{
    if(m_wai_auditorium->GetStateNameCurrent().compare("PlenumPresenting")==0)
    {
        m_wai_auditorium->SetTimeTriggerActivated(ros::Time::now());
        m_wai_auditorium->StateTransitionTo(new StateLearningModeScaffoldingPrepare,true);
    }
}
                               ...
                               float f_trigger_timeout)
{
    ...
    */
    ...
    //========================
    // 0.SESSION Interactions
    m_trg_session_load=new WAIAuditoriumTriggerSessionLoad(m_wai_open_auditorium); // KEY
    // 1.SCENE Interactions
    ...
    m_trg_mood=new WAIAuditoriumTriggerMood(m_wai_open_auditorium); // KEY
    m_trg_presence_visual=new WAIAuditoriumTriggerPresenceMode(m_wai_open_auditorium); // KEY JOY MOB VOI
    ...
    m_trg_voice_command_marvin=new WAIAuditoriumTriggerVoiceCommandMarvin(m_wai_open_auditorium); // KEY MOB
    ...
    m_trg_audience_share_material=new WAIAuditoriumTriggerAudienceShareMaterial(m_wai_open_auditorium); // KEY
    ...
    // 7.LEARNING MODE Interactions
    m_trg_learning_mode_plen=new WAIAuditoriumTriggerLearningModePlen(m_wai_open_auditorium); // KEY
    m_trg_learning_mode_coop=new WAIAuditoriumTriggerLearningModeCooperative(m_wai_open_auditorium); // KEY
    m_trg_learning_mode_scaff=new WAIAuditoriumTriggerLearningModeScaffolding(m_wai_open_auditorium); // KEY
    ...
    sub_bol_trg_mob_presence_visual=m_hdl_node->subscribe("trg_mob_presence_visual", 1, &WAIOATriggers::cb_sub_bol_trg_mob_presence_visual,this);
    ...
    sub_bol_trg_mob_voice_command_marvin=m_hdl_node->subscribe("trg_mob_voice_command_marvin", 1, &WAIOATriggers::cb_sub_bol_trg_mob_voice_command_marvin,this);
...
void WAIOATriggers::CheckTriggersKeyboard()
{
    ...
    */
    ...
    else if(b_keyboard_modifier && (KeyIsPressed(XK_KP_Page_Up)||KeyIsPressed(XK_Page_Up)) )
    {
        m_s_oa_event_inpdev_last="[KEY] MOOD";
        m_trg_mood->Activate();
    }
    else if(b_keyboard_modifier && KeyIsPressed(XK_o))
    {
        m_s_oa_event_inpdev_last="[KEY] PRESENCE";
        m_trg_presence_visual->Activate();
    }
    ...
    {
        m_s_oa_event_inpdev_last="[KEY] LOAD SESSION";
        m_trg_session_load->Activate();
    }
    ...
    else if(b_keyboard_modifier && KeyIsPressed(XK_c)) // Both, Intel and Marvin can be triggered seperately by the user!
    {
        m_s_oa_event_inpdev_last="[KEY] VOICE Command Intel";
        m_trg_voice_command->Activate();
    }
    else if(b_keyboard_modifier_alt && KeyIsPressed(XK_c)) // Both, Intel and Marvin can be triggered seperately by the user!
    {
        m_s_oa_event_inpdev_last="[KEY] VOICE Command Marvin";
        m_trg_voice_command_marvin->Activate();
    }
    ...
    else if(b_keyboard_modifier && KeyIsPressed(XK_Control_L))
    {
        m_s_oa_event_inpdev_last="[KEY] AUD Share";
        m_trg_audience_share_material->Activate();
    }
    ...
    {
        m_s_oa_event_inpdev_last="[KEY] DET Focus";
    ...
    else if(b_keyboard_modifier_alt && KeyIsPressed(XK_3))
    {
        m_s_oa_event_inpdev_last="[KEY] MODE Scaffolding";
        m_trg_learning_mode_scaff->Activate();
    }
    else
    {
        // Do nothing...
...
void WAIOATriggers::cb_sub_bol_trg_mob_presence_visual(const std_msgs::BoolPtr& msg)
{
    b_trg_mob_presence_visual=msg->data;
}
...
void WAIOATriggers::cb_sub_bol_trg_mob_voice_command_marvin(const std_msgs::BoolPtr& msg)
{
    b_trg_mob_voice_command_marvin=msg->data;
}
...
void WAIOATriggers::CheckTriggersMobile()
{
    ...
    else if(b_trg_mob_presence_visual)
    {
    ...
    {
        m_s_oa_event_inpdev_last="[MOB] VOICE Command Intel";
        m_trg_voice_command->Activate();
    }
    else if(b_trg_mob_voice_command_marvin)
    {
        m_s_oa_event_inpdev_last="[MOB] VOICE Command Marvin";
        m_trg_voice_command_marvin->Activate();
    }
...
void WAIOATriggers::ResetBoolEventTriggersMobile()
{
    ...
    b_trg_mob_presence_visual=false;
    ...
    b_trg_mob_voice_command_marvin=false;
...
void WAIOATriggers::ResetBoolEventTriggersVoice()
{
    ...
    b_trg_voi_scene_prev=false;
    b_trg_voi_scene_next=false;
    b_trg_voi_camera_rviz_default=false;
    b_trg_voi_camera_rviz_cycle=false;
    b_trg_voi_camera_rviz_enforce=false;
    b_trg_voi_camera_rviz_idle=false;
    b_trg_voi_camera_rviz_follow=false;
    b_trg_voi_introduction=false;
    b_trg_voi_presence_visual=false;
    b_trg_voi_body_interaction=false;
    b_trg_voi_avatar=false;
    b_trg_voi_lectern=false;
    b_trg_voi_table=false;
    b_trg_voi_audience_eval_graph=false;
    b_trg_voi_audience_eval_metaphorebowl=false;
    b_trg_voi_audience_eval_metaphorebalance=false;
    b_trg_voi_audience_eval_metaphoremarvin=false;
    b_trg_voi_audience_request_reject=false;
    b_trg_voi_audience_request_accept=false;
    b_trg_voi_audience_focus_down=false;
    b_trg_voi_audience_focus_up=false;
    b_trg_voi_audience_focus_left=false;
    b_trg_voi_audience_focus_right=false;
    b_trg_voi_wim_audience_select=false;
    b_trg_voi_audience_eval_part_minus=false;
    b_trg_voi_audience_eval_part_tilde=false;
    b_trg_voi_audience_eval_part_plus=false;
    b_trg_voi_audience_eval_exam_insufficient=false;
    b_trg_voi_audience_eval_exam_sufficient=false;
    b_trg_voi_audience_eval_exam_satisfactory=false;
    b_trg_voi_audience_eval_exam_good=false;
    b_trg_voi_audience_eval_exam_very_good=false;
    b_trg_voi_rep_detail_focus=false;
    b_trg_voi_rep_detail_rot=false;
    b_trg_voi_rep_detail_select=false;
    b_trg_voi_learning_mode_plen=false;
    b_trg_voi_learning_mode_coop=false;
}

...
private:
  ...
  void updateResult(const RhinoRecognizerData::Result& result, GetIntentResult& action_result) override
  {
    ...
    for (const auto& slot : result.slots_)
    {
      ...
      action_result.picoslots.push_back(kv);
    }
  }
...
int main(int argc, char** argv)
{
  ...
  auto contexts_directory_url = local_nh.param("contexts_directory_url", defaultResourceUrl() + "/contexts"); // Current version is 3.0.0 (also refer to https://github.com/Picovoice/rhino)

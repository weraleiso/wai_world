...
class win_wai_oa : public QMainWindow
{
    ...
    std::string s_path_wai_oa_session_scene_previews;
...
public:
    ...
    Qt::CheckState GetWAIOAPresenterMode();
    int GetWAIOAPresenterListenerID();
    void SetWAIOAPresenterListenerID(int i_id);
    ...
    std::string GetSessionSelectedFilename();
...
private slots:
    ...
    void on_chk_wai_oa_infra_pre_or_aud_stateChanged(int arg1);
